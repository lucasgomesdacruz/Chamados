...
export function FormTicket({ customer }: FormTicketProps) {
    ...
    return(
        <form className="bg-slate-200 mt-6 px-4 py-6 rounded-sm border-2" onSubmit={handleSubmit(handleRegisterTicket)}>
            ...
            <label className="mb-1 font-medium text-lg">Descreva seu problema</label>
            <textarea 
