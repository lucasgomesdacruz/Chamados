...
export default async function NewTicket() {
    ...
    async function hadleRegisterTIcket(formData: FormData) {
       "use server" 
    ...
    return (
        <Container>
          <main className="mt-9 mb-2">
                ...
                <form className="flex flex-col mt-6" action={hadleRegisterTIcket}>
                    ...
                    {customers.length === 0 && (
                        <Link href="/dashboard/customer/new">
                            Você ainda não têm nenhum cliente, <span className="text-blue-500 font-medium">Cadastrar cliente</span>
                        </Link>
                    )} 
