...
export function ModalTicket() {
    const { hanldeModalVisible, ticket } = useContext(ModalContext)
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div ref={modalRef} className="bg-white shadow-lg w-4/5 md:w-1/2 max-w-2xl p-3 rounded">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button className="bg-red-500 p-1 px-2 text-white rounded" onClick={hanldeModalVisible}>
                            Fechar
                        </button>
                    ...
                    <div className="w-full border-b-[1.5px] my-4">
                        <h1 className="dont-bold text-lg mb-4">Detalhes do cliente</h1>
